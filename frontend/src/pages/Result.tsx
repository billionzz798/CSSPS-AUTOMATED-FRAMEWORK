...
const styles: Record<string, React.CSSProperties> = {
  ...
  fairnessItem: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '18px 20px', borderRadius: 8, border: '2px solid rgba(210, 16, 52, 0.2)', transition: 'all 0.2s ease', background: 'linear-gradient(135deg, #ffffff 0%, #f8fbfc 100%)' },
  ...
  th: {
    ...
    borderBottom: '2px solid rgba(210, 16, 52, 0.15)',
    fontSize: 15,
    fontWeight: 900,
    color: 'var(--text)',
  },
  td: { padding: '16px 20px', borderBottom: '1px solid rgba(210, 16, 52, 0.1)', fontSize: 15, color: 'var(--text)', fontWeight: 600 },
